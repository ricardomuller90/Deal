...
$(document).ready(function(){
 ...
 $("#numHoras").blur(function(){ calcula();
});
 ...
 $("#mesesTrabalhados").blur(function(){ calcula();
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Adicional Noturno com Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT adicNot.valor, adicNot.numHoras, adicNot.adicional, adicNot.numHorasPleit, adicNot.mesesTrabalhados, processo.remHab as remHab, difSalariais.valor as difSal,insalubridade.adicional as insAdic ,insalubridade.salarioMin as insSalMin , periculosidade.salarioMin as perSalMin FROM adicNot INNER JOIN processo ON adicNot.idProcesso=processo.idProcesso INNER JOIN insalubridade ON processo.idProcesso=insalubridade.idProcesso INNER JOIN periculosidade ON periculosidade.idProcesso=adicNot.idProcesso INNER JOIN difSalariais ON difSalariais.idProcesso=processo.idProcesso  WHERE processo.idProcesso = :idProcesso');
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="numHoras" name="numHoras" class="form-control" placeholder="220" maxlength="3" value="<?php if(isset($row['numHoras'])){echo $row['numHoras'];}?>">
                                            </div>
                                        </div>
                                    </div>
        ...
        break;
    case 0.5:
         echo '<option value="0.5">50%</option><option value="0.2">20%</option>
               </select>';
       break;
    default:
        echo '<option value="0">0%</option><option value="0.2">20%</option><option value="0.5">50%</option>
               </select>';
       break;
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de adicional noturno com aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h1>
  <p>
Preencha os dados solicitados para obter o valor da parcela, com o preenchimento dos dados será efetuado o seguinte cálculo:
  ...
  <p style="font-weight: bolder"> remuneração habitual mensal paga + pleitos mensais : carga horária mensal x adic. noturno x número de horas noturnas x número de meses obedecendo a prescrição + 30% (referente as integrações de aviso, 13º. Salários e férias c/1/3), caso seja escolhido esta opção na página inicial dos cálculos.
    <br><br></p>
...
<div class="remodal" data-remodal-id="modal3">
  <button data-remodal-action="close" class="remodal-close"></button>
  <h1>Digitar o número de horas noturnas pleiteadas neste mês</h1>
  <p>
  Se for preciso acrescer a reduzida noturna, segue a dica:</br>
Para calcular a reduzida noturna é muito fácil basta saber o número de horas noturnas no dia e dividir por 7, o resultado desta divisão é a reduzida noturna
número de horas noturnas por dia + reduzida noturna x número de dias laborados por semana x 4,29 semanas (média real aritmética do número de semanas = 30 dias : 7 dias = número de horas noturnas mensais.</br>
Exemplo:
Labor das 22hs. às 07hs. = 9 horas noturnas por dia</br>
Reduzida = 9hs. : 7 = 1,29hs.</br>
Total = 9hs. + 1,29hs. = 10,29hs. horas noturna com a reduzida x 6 dias = 61,74 horas noturnas por semana x 4,29 semanas = 264,86 horas noturnas por mês
