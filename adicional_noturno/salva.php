...
// $isoDate = dateConvert($birthdate);
		...
		$PDO = db_connect();
        $stmt = $PDO->prepare('SELECT * FROM adicNot WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario');
...
// atualiza o banco
$sql = "UPDATE adicNot SET valor = :valor, numHoras = :numHoras, adicional = :adicional, numHorasPleit = :numHorasPleit, mesesTrabalhados = :mesesTrabalhados, totalSemFgts = :totalSemFgts, fgtsEmultas = :fgtsEmultas WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario";
