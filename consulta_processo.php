...
<div class="wrapper">
  ...
  <h3 style="margin-bottom:40px ">Consultar Processos</h3>
...
<table id="table_id" class="cell-border" >
      ...
      $PDO = db_connect(); 
        ...
        <tr><td><?php echo '<a href="opcoes.php?idProcesso='.$row['idProcesso'].'">'.$row['numProc'].'</a>';?></td><td><?php echo '<a href="opcoes.php?idProcesso='.$row['idProcesso'].'">'.$row['nomeAutor'].'</a>';?></td><td><?php echo '<a href="opcoes.php?idProcesso='.$row['idProcesso'].'">'.$row['reuEmpresa'].'</a>';?></td><td style="text-align:center;"><a href="apaga_processo.php?idProcesso=<?php echo $row['idProcesso']?>">x</a></td></tr>
        <?php } ?>
        </tbody>
