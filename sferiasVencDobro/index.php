...
?>
    ...
    var val = converteMoedaFloat(remHab);


    var qtd = $( "#qtd" ).val();
  
    var total = val * 1.3333 * 2 * qtd;
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Férias em dobro <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT * FROM feriasVencidasDobro WHERE idProcesso = :idProcesso');
        $stmt->bindValue(':idProcesso', $_GET['idProcesso']);
        $stmt->execute();
        $valores = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach ($valores as $row){
...
?>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="remHab" name="remHab" disabled onkeyup="formatarMoeda()" class="form-control" value="<?php if(isset($remHab)){echo $remHab;}?>">

                                            </div>
                                            <input type="hidden" name="totalSemFgts" id="totalSemFgts" value="">
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">  <div class="form-group">
                                                <label for="mesesTrabalhados">Quantidade de férias vencidas em dobro</label>
                                                <input type="text" id="qtd" name="qtd" maxlength="1" class="form-control" value="<?php if(isset($qtd)){echo $qtd;}?>">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><b>Total de férias em dobro</b><p id="total"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h3>Cálculo de ferias em dobro </h3>
  <p>
    Preenchimento automático com a seguinte fórmula:

  </p></br>
  <p style="font-weight: bolder"> Remuneração habitual digitada na página inicial + 1/3 de férias x 2 x quantidade de férias em dobro não pagas
    <br><br></p>
