		...
		<form id="form-info" method="post">
			<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="form-group">
					...
					<input type="hidden" id="assinatura-descricao" class="form-control" value="DEAL - Plano Semestral" required="" readonly="readonly">
				</div>
				<div class="form-group">
					<label for="assinatura-interval">Intervalo (periodicidade) da cobrança: <br></label>
					<p class="ex">Semestral</p>
					<input type="hidden" id="assinatura-interval" class="form-control" required value="6"  readonly="readonly" placeholder="Intervalo (em meses) da cobrança gerada">
				</div>
				<!--<div class="form-group">
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="form-group">
					...
					<input type="hidden" id="item-name" class="form-control" value="DEAL - Plano Semestral" required="" readonly="readonly">
				</div>
				<div class="form-group">
					<label for="item-value">Valor: <br></label>
							<p class="ex">309,90 / a cada 6 meses</p>
					<input type="hidden" class="form-control" value="R$ 309,90 / mês" required="" readonly="readonly">
				</div>
				<!--<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="hidden" id="item-value" class="form-control"  value="30990"
					required readonly="readonly">
