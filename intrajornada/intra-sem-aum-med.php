            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Horas Intrajornada SEM Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
   ...
   echo '<option value="1.5">50%</option><option value="1.5">50%</option><option value="2">100%</option>
    ...
    case 1.6:
       ...
       break;
           case 2:
         echo '<option value="2">100%</option><option value="1.6">60%</option><option value="1.5">50%</option><option value="2">100%</option>
               </select>';
       break;
    default:
