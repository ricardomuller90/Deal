            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Intrajornada com Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT intrajornada.valor, intrajornada.numHoras, intrajornada.adicional, intrajornada.numHorasPleit, intrajornada.mesesTrabalhados, processo.remHab as remHab, difSalariais.valor as difSal,insalubridade.adicional as insAdic ,insalubridade.salarioMin as insSalMin , periculosidade.salarioMin as perSalMin FROM intrajornada INNER JOIN processo ON intrajornada.idProcesso=processo.idProcesso INNER JOIN insalubridade ON processo.idProcesso=insalubridade.idProcesso INNER JOIN periculosidade ON periculosidade.idProcesso=intrajornada.idProcesso INNER JOIN difSalariais ON difSalariais.idProcesso=processo.idProcesso  WHERE processo.idProcesso = :idProcesso ');
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="mesesTrabalhados" name="mesesTrabalhados" class="form-control" value="<?php if(isset($mesesTrab)){echo $mesesTrab;}?>">
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de intrajornada <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h1>
  <p>
  ...
  <p style="font-weight: bolder"> remuneração habitual mensal paga + pleitos mensais / carga horária mensal x adic. Horas extras x número de horas intra x número de meses obedecendo a prescrição + 30% (referente as integrações de aviso, 13º. Salários e férias c/1/3), caso seja escolhido esta opção na página inicial dos cálculos
    <br><br></p>
...
<div class="remodal" data-remodal-id="modal3">
  <button data-remodal-action="close" class="remodal-close"></button>
  <h1>Digitar o número de horas intra pleiteadas neste mês.</h1>
  <p>
   
Dica para encontrar o número de horas intra por mês:</br>
Intrajornada é o intervalo das refeições e descanso</br>
Se houve labor além das 6 horas sem intervalo = 1 hora x número de dias no mês em que não foi respeitado o intervalo de até 1 hora</br>
Se houve labor além de 4 horas até 6 horas sem intervalo = 15 minutos por dia x número de dias no mês em que não foi respeitado o intervalo de 15 minutos</br>
