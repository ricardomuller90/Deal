...
function calculo(){
       ...
       demissao = new Date($("#demissao").val());  
  
   admissao = new Date($("#admissao").val());  
   var diferencaAnos = demissao.getFullYear() - admissao.getFullYear();  
   if (new Date(demissao.getFullYear(), demissao.getMonth(), demissao.getDate()) <  
       new Date(demissao.getFullYear(), admissao.getMonth(), admissao.getDate()))  
     diferencaAnos--;  
...
var cont = 30+3*diferencaAnos;
  ...
  if(cont>90){
   ...
   var salarioFloat = converteMoedaFloat(salario);

   var total = salarioFloat*cont/30;
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de aviso-prévio indenizado e proporcional <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php $salario = number_format($salario, 2, ',', '.');  ?>


  
                        <?php   $PDO = db_connect();      
                                $stmt = $PDO->prepare('SELECT * FROM aviso_previo WHERE idProcesso = :idProcesso');
                                $stmt->bindValue(':idProcesso', $_GET['idProcesso']);
                                $stmt->execute();
                                $valores = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                foreach ($valores as $row){
    ...
    default:
      echo '<option value="0" selected>Erro. Acionar suporte.</option>';
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="mesesTrabalhados">Salário</label>
                                                <input type="text" id="salario" name="salario" disabled onkeyup="formatarMoeda();" class="form-control" value="<?php if(isset($remHab)){echo $remHab;}?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="admissao" disabled name="admissao" class="form-control" value="<?php if(isset($admissao)){echo $admissao;}?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                             <label>Demissão</label>
                                             <input type="date" id="demissao" disabled name="demissao" class="form-control" value="<?php if(isset($demissao)){echo $demissao;}?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><b>Total de aviso prévio</b><p id="total"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h3>Cálculo de aviso-prévio indenizado e proporcional</h3>
  <p>
  ...
  <p style="font-weight: bolder">Remuneração habitual preenchida na página inicial / 30 dias e multiplicado pelo número de meses de acordo com a Lei do aviso prévio proporcional, ou seja, 30 dias + 3 dias a cada ano completo até uma limitação de 90 dias totais
  </p></br>
    </p>
