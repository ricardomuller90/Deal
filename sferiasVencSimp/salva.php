...
// $isoDate = dateConvert($birthdate);
		...
		$PDO = db_connect();
        $stmt = $PDO->prepare('SELECT * FROM feriasVencidas WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario');
...
// atualiza o banco
$sql = "UPDATE feriasVencidas SET totalSemFgts = :totalSemFgts, qtd = :qtd  WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario";
