            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Férias Simples <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT * FROM feriasVencidas WHERE idProcesso = :idProcesso');
        $stmt->bindValue(':idProcesso', $_GET['idProcesso']);
        $stmt->execute();
        $valores = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach ($valores as $row){
...
?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">  <div class="form-group">
                                                <label for="mesesTrabalhados">Quantidade de férias vencidas simples</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><b>Total de férias simples</b><p id="total"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h3>Cálculo de ferias simples </h3>
  <p>
    Preenchimento automático com a seguinte fórmula:

  </p></br>
  <p style="font-weight: bolder"> Remuneração habitual digitada na página inicial + 1/3 de férias x quantidade de férias simples não pagas
    <br><br></p>
