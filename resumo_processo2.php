...
<?php        
        $stmt2 = $PDO->prepare('SELECT SUM(m.total477 + m.total467 + id.total + ap.totalSemFgts+ fv.totalSemFgts+ fvd.totalSemFgts + fp.totalSemFgts + dm.total) as subtotal FROM multas as m INNER JOIN indDiv as id ON id.idProcesso = m.idProcesso INNER JOIN aviso_previo as ap ON ap.idProcesso = m.idProcesso INNER JOIN feriasVencidas as fv ON fv.idProcesso = m.idProcesso INNER JOIN feriasVencidasDobro as fvd ON fvd.idProcesso = m.idProcesso INNER JOIN feriasProp as fp ON fp.idProcesso = m.idProcesso INNER JOIN danMor as dm ON dm.idProcesso = m.idProcesso WHERE m.idProcesso=:idProcesso');
                                ...
                                <div class="row">
                                  ...
                                  ?>
                                     ...
                                     <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php  if($advDe == '2'){ ?><label>Redutor</label>
