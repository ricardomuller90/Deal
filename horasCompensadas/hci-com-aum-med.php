...
require_once '../config/init.php'; require_once '../include/query_processo.php';
?>
<!doctype html>
<html lang="en">
<head>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Horas Compensadas e Irregulares com Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT hrIrreg.valor, hrIrreg.numHoras, hrIrreg.adicional, hrIrreg.numHorasPleit, hrIrreg.mesesTrabalhados, processo.remHab as remHab, difSalariais.valor as difSal,insalubridade.adicional as insAdic ,insalubridade.salarioMin as insSalMin , periculosidade.salarioMin as perSalMin FROM hrIrreg INNER JOIN processo ON hrIrreg.idProcesso=processo.idProcesso INNER JOIN insalubridade ON processo.idProcesso=insalubridade.idProcesso INNER JOIN periculosidade ON periculosidade.idProcesso=hrIrreg.idProcesso INNER JOIN difSalariais ON difSalariais.idProcesso=processo.idProcesso  WHERE processo.idProcesso = :idProcesso ');
        ...
        echo '<input type="hidden" value="'.$valor.'" id="valor1">';  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="numHoras" name="numHoras" placeholder="220" maxlength="3" class="form-control" value="<?php if(isset($row['numHoras'])){echo $row['numHoras'];}?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                  <label>Adicional Horas Compensadas e Irregulares</label>
        ...
        break;
    case 0:
         echo '   <option value="0">0%</option><option value="0.5">50%</option>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                <label><b>Total de horas compensadas e irregulares</b><p id="subtotal"></p></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                <label><b>Integrações em aviso, 13° salários e férias com 1/3 com aumento da média remuneratória</b><p id="totalInts"></p></label>
...
<div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de horas compensadas e irregulares</h1>
  <p>
    Preencha os dados solicitados para ter o valor da parcela, seguindo a seguinte fórmula:
  </p></br>
  <p style="font-weight: bolder">remuneração habitual mensal paga + pleitos mensais : carga horária mensal x adic. Horas extras x número de horas compensadas x número de meses obedecendo a prescrição + 30% (referente as integrações de aviso, 13º. Salários e férias c/1/3), caso seja escolhido esta opção na página inicial dos cálculos
    <br><br></p>
...
<div class="remodal" data-remodal-id="modal3">
  <button data-remodal-action="close" class="remodal-close"></button>
  <h1>digitar o número de horas compensadas pleiteadas neste mês.</h1>
  <p>
 

Dica para encontrar o número de horas compensadas:</br>
A hora compensada é aquele número de horas laboradas a mais para compensar o sábado, sendo assim, se o advogado conseguir anular esta compensação, o Autor tem direito a receber as horas laboradas além da 8ª. diária até o limite desta compensação, pois estas horas já foram pagas pelo valor da hora normal, faltando apenas o adicional de horas extras (0,5).</br>
Exemplo:
Um labor de 8 horas e 48 minutos de segunda à sexta-feira = 44 horas semanais</br>
Se houver a anulação desta compensação, o Autor tem direito de 48 minutos com o adicional de 50%.</br>
48 minutos : 60 minutos = 0,80hs. por dia x 5 dias = 4 horas por semana (justamente a compensação do sábado)</br>
Para transformar em mensal = 4 horas x 4,29 semanas = 17,16 horas extras por mês
