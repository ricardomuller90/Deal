...
// $isoDate = dateConvert($birthdate);
		...
		$PDO = db_connect();
        $stmt = $PDO->prepare('SELECT * FROM clt384 WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario');
...
// atualiza o banco
$sql = "UPDATE clt384 SET valor = :valor, numHoras = :numHoras, adicional = :adicional, numHorasPleit = :numHorasPleit, mesesTrabalhados = :mesesTrabalhados, totalSemFgts = :totalSemFgts, fgtsEmultas = :fgtsEmultas  WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario";
