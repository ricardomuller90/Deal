            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Outros Intervalos com Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT outrosInterv.valor, outrosInterv.numHoras, outrosInterv.adicional, outrosInterv.numHorasPleit, outrosInterv.mesesTrabalhados, processo.remHab as remHab, difSalariais.valor as difSal,insalubridade.adicional as insAdic ,insalubridade.salarioMin as insSalMin , periculosidade.salarioMin as perSalMin FROM outrosInterv INNER JOIN processo ON outrosInterv.idProcesso=processo.idProcesso INNER JOIN insalubridade ON processo.idProcesso=insalubridade.idProcesso INNER JOIN periculosidade ON periculosidade.idProcesso=outrosInterv.idProcesso INNER JOIN difSalariais ON difSalariais.idProcesso=processo.idProcesso  WHERE processo.idProcesso = :idProcesso ');
        ...
        break;
             case 1.6:
        echo '<option value="1.6">60%</option>
        ...
        break;
    case 2:
         echo '<option value="2.0">100%</option><option value="1.6">60%</option><option value="1.5">50%</option>
               </select>';
       break;
    default:
    	echo '<option value="0">0%</option><option value="2.0">100%</option><option value="1.6">60%</option><option value="1.5">50%</option>
               </select>';
       break;
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                <label><b>Integrações em aviso, 13° salários, férias com 1/3 com aumento da média remuneratória</b><p id="totalInts"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de outros intervalos</h1>
  <p>
...
<div class="remodal" data-remodal-id="modal3">
  <button data-remodal-action="close" class="remodal-close"></button>
  <h1>digitar o número de horas de outros intervalos pleiteados neste mês.</h1>
  <p>
    
Este campo destina-se a outros intervalos pleiteados, como intervalo de digitação, câmera fria, etc.</br>
A forma do cálculo de número de horas mensais, será de acordo com o intervalo pleiteado</br>
Exemplo – digitador artigo 72 CLT – a cada 90 minutos laborados = 10 minutos de descanso</br>
Labor de 10 horas por dia.</br>
Dica transformar as 10 horas em minutos para sabermos a quantidade de pausas:</br>
10 horas x 60 minutos = 600 minutos laborados : 90 minutos = 6,67 pausas = 6 pausas de 10 minutos</br>
10 minutos : 60 minutos = 0,17hs. x 6 pausas = 1,02hs. extras neste dia x número de dias no mês em que não foi respeitado este intervalo
  </p></br>
