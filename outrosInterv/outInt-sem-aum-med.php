            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de outros intervalos SEM aumento da média remuneratória<a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                <label><b>Integrações em aviso, 13° salários e férias com 1/3 sem aumento da média remuneratória</b><p id="totalInts"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de Outros invervalos</h1>
  <p>
