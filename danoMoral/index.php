...
<?php
    ...
    $remHab = $row['remHab'];
    $danoMoral = $row['danMor'];


    $totalDanMor = $remHab *$danoMoral;
    $totalDanMorFloat = $totalDanMor;
        if(!empty($totalDanMor)){
        $totalDanMor = number_format($totalDanMor, 2, ',', '.');
        }else{$totalDanMor= 0;
        }
...
<div class="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de dano moral <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
                                <form action="salva.php" method="post">
                                    <input type="hidden" name="idProcesso" value="<?php echo $_GET['idProcesso']?>">
                                     <input type="hidden" name="total"  value="<?php echo $totalDanMorFloat; ?>>">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Dano moral</label>
                                                <p class="form-control"><?php if(isset($danoMoral)){switch($danoMoral){
    ...
    default:
      echo '<option value="0" selected>NÃO</option>';
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><b>Total de Dano Moral</b><p id="total"><?php echo $totalDanMor; ?></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h3>Cálculo de dano moral </h3>
  <p>
    Digitado na página inicial o tipo de dano, aqui constam as explicações sobre os mesmos:
  </p></br>
  <p style="font-weight: bolder">
natureza leve (até três vezes o último salário do ofendido)</br>
média (até cinco vezes o último salário)</br>
grave (até vinte vezes o último salário)</br>
