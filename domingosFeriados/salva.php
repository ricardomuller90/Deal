...
// $isoDate = dateConvert($birthdate);
		...
		$PDO = db_connect();
        $stmt = $PDO->prepare('SELECT * FROM domingosFeriados WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario');
...
// atualiza o banco
$sql = "UPDATE domingosFeriados SET valor = :valor, numHoras = :numHoras, adicional = :adicional, numHorasPleit = :numHorasPleit, mesesTrabalhados = :mesesTrabalhados, totalSemFgts = :totalSemFgts, fgtsEmultas = :fgtsEmultas WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario";
