            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de domingos e feriados com Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT domingosFeriados.valor, domingosFeriados.numHoras, domingosFeriados.adicional, domingosFeriados.numHorasPleit, domingosFeriados.mesesTrabalhados, processo.remHab as remHab, difSalariais.valor as difSal,insalubridade.adicional as insAdic ,insalubridade.salarioMin as insSalMin , periculosidade.salarioMin as perSalMin FROM domingosFeriados INNER JOIN processo ON domingosFeriados.idProcesso=processo.idProcesso INNER JOIN insalubridade ON processo.idProcesso=insalubridade.idProcesso INNER JOIN periculosidade ON periculosidade.idProcesso=domingosFeriados.idProcesso INNER JOIN difSalariais ON difSalariais.idProcesso=processo.idProcesso  WHERE processo.idProcesso = :idProcesso');
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de domingos e feriados com aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h1>
  <p>
Preencha os dados solicitados para obter o valor da parcela, com o preenchimento dos dados será efetuado o seguinte cálculo:
  ...
  <p style="font-weight: bolder"> remuneração habitual mensal paga + pleitos mensais : carga horária mensal x adic. Horas extras x número de horas laboradas em domingos/feriados x número de meses obedecendo a prescrição + 30% (referente as integrações de aviso, 13º. Salários e férias c/1/3), caso seja escolhido esta opção na página inicial dos cálculos
    <br><br></p>
...
<div class="remodal" data-remodal-id="modal3">
  <button data-remodal-action="close" class="remodal-close"></button>
  <h1>digitar o número de horas laboradas em domingos/feriados pleiteados neste mês</h1>
  <p>

Número de horas laboradas em domingos e feriados:</br>
Neste campo é usualmente arbitrado 1 até 4 domingos por mês e feriados 1 por mês,  – arbitra-sedo em e os feriados computar uma média de 1 por mês (já que durante o ano teremos uma média de 12 feriados).
  </p></br>
