            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Saldo Salário<!-- <a href="#modal"><img src="../img/ajuda.png" width="30"></a>--></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT * FROM saldoSal WHERE idProcesso = :idProcesso');
        $stmt->bindValue(':idProcesso', $_GET['idProcesso']);
        $stmt->execute();
        $valores = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach ($valores as $row){
...
$salario = $remHab;
echo '<input type="hidden" value="'.$salario.'" id="salario">';
...
?>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Remuneração habitual mensal paga </label>
                                                <input type="text" id="valores" name="salario" onkeyup="formatarMoeda()" readonly="readonly" class="form-control" value="<?php if(isset($salario)){echo $salario;}?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">  <div class="form-group">
                                                <label for="mesesTrabalhados">Dias Trabalhados</label>
                                                <input type="text" id="diasTrab" name="diasTrab" maxlength="2" class="form-control" value="<?php if(isset($diasTrab)){echo $diasTrab;}?>">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><b>Total em saldo salário</b><p id="total"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <p style="font-weight: bolder"> Valores Diferenças = (Comissões + adicional por tempo de serviço + diferenças de convenção coletiva + diferenças equip. + diferenças de desvio) </br></br> X N° de meses trabalhados </br><br> + 30% (referente a aviso, 13° salário e Férias). 
    <br><br></p>
