    ...
    var calcular = $( this ).val();
		...
		function calculo() {
			...
			if (remuneracao && remuneracao !== '0' && dataAdmissaoInput && dataDemissaoInput) {
				...
				dataAdmissao = new Date(dataDemissaoNova.getFullYear(), dataAdmissao.getMonth(), dataAdmissao.getDate());
				
				var timeDiffResult = Math.abs(dataDemissaoNova.getTime() - dataAdmissao.getTime());
				var mesesTrabalhados = parseInt(Math.ceil(timeDiffResult / (1000 * 3600 * 24)) / 12);
