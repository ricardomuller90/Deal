            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Interjornada com Aumento da média remuneratória <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php   $PDO = db_connect();      
        $stmt = $PDO->prepare('SELECT interjornada.valor, interjornada.numHoras, interjornada.adicional, interjornada.numHorasPleit, interjornada.mesesTrabalhados, processo.remHab as remHab, difSalariais.valor as difSal,insalubridade.adicional as insAdic ,insalubridade.salarioMin as insSalMin , periculosidade.salarioMin as perSalMin FROM interjornada INNER JOIN processo ON interjornada.idProcesso=processo.idProcesso INNER JOIN insalubridade ON processo.idProcesso=insalubridade.idProcesso INNER JOIN periculosidade ON periculosidade.idProcesso=interjornada.idProcesso INNER JOIN difSalariais ON difSalariais.idProcesso=processo.idProcesso  WHERE processo.idProcesso = :idProcesso ');
   ...
   echo '<option value="1.5">50%</option><option value="1.5">50%</option><option value="2">100%</option>
    ...
    case 1.6:
       ...
       break;
          ...
          case 2:
         echo '<option value="2">100%</option><option value="1.6">60%</option><option value="1.5">50%</option>
               </select>';
       break;
    default:
...
<div class="remodal" data-remodal-id="modal3">
  <button data-remodal-action="close" class="remodal-close"></button>
  <h1> digitar o número de horas inter pleiteadas neste mês.</h1>
  <p>
 
Dica para encontrar o número de horas por mês:</br>
Interjornada é o intervalo de 11 horas entre o término da jornada até o começo da jornada do outro dia</br>
Então o direito é a diferença que ficou faltando deste descanso para completar as 11 horas, exemplo:</br>
Horário:
08:00hs. às 12:00hs. e das 13:00hs. às 24:00hs.</br>
O outro dia o Autor também iniciou às 8 da manhã, sendo assim, das 24hs. até às 8hs. do outro dia teremos um descanso de apenas 8 horas, quando o correto seria 11 horas, sendo assim, uma diferença de 3 horas extras por dia.</br>
Diferença destes número de horas por dia x número de dias no mês em que não foi respeitado o intervalo interjornada
  </p></br>
