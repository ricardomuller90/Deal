            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Novo processo</h4>
                            </div>
                            <div class="content">
                                <form action="adiciona_processo.php" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="numProc">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                  <label>Empresa</label>
                                                <input type="text" name="reuEmpresa" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <input type="date" name="demissao" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 60px">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                 <label>Remuneração habitual <a href="#modal"><img src="img/ajuda.png" height="20"></a> </label>
                                                <input type="text"  class="form-control" id="valor" onkeyup="formatarMoeda();">
                                                <input type="hidden" id="remHab" name="remHab">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>N° de meses trabalhados não prescritos</label>
                                               <input type="text" name="mesesTrab" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <select class="form-control" name="danMor">
                                               		...
                                               		<option value="20">GRAVE</option>
                                               		<option value="50">GRAVÍSSIMO</option>
                                               </select>
                                            </div>
                                        </div>
                                    </div>
