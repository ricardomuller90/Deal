...
function calcula(){
    ...
    var subtotal = salarioMin *  30 /100 * mesesTrabalhados;

    var integracoes = (subtotal * 30 / 100) * <?php echo $reflexos; ?>;

    var total = subtotal + integracoes;
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de Periculosidade <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
<?php        
        $stmt = $PDO->prepare('SELECT * FROM periculosidade WHERE idProcesso = :idProcesso');
        $stmt->bindValue(':idProcesso', $_GET['idProcesso']);
        $stmt->execute();
        $valores = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach ($valores as $row){
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>último salário-base percebido no contracheque – Base 30 dias</label>
                                        ...
                                        <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="text" id="mesesTrabalhados" name="mesesTrabalhados" maxlength="2" class="form-control" readonly = "readonly" value="<?php if(isset($mesesTrab)){echo $mesesTrab;}?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="totalSemFgts" name="totalSemFgts" value="">
                                                <input type="hidden" id="totalTudo" name="totalTudo" value="">
                                                 <input type="hidden" id="fgtsEmultas" name="fgtsEmultas" value="">
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h1>Cálculo de periculosidade</h1>

  <b><img src="../img/ajuda.png" width="30">Caso haja periculosidade, voce deve preencher esse campos antes de fazer os cálculos de hora extra, adicional noturno, horas intrajornada e interjornada, horas compensadas e irregulares, clt 384, domingos e feriados e outros intervalos. Pois eles dependem dos dados da insalubridade para fazer esses cálculos.<img src="../img/ajuda.png" width="30"></b></br></br>
...
Salário-base x 30% x número de meses obedecendo a prescrição + 30% (referente as integrações de aviso, 13º. Salários e férias c/1/3), caso seja escolhido esta opção na página inicial dos cálculos
    <br><br></p>
