...
// $isoDate = dateConvert($birthdate);
		...
		$PDO = db_connect();
        $stmt = $PDO->prepare('SELECT * FROM insalubridade  WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario');
...
// atualiza o banco
$sql = "UPDATE insalubridade SET adicional = :adicional,  salarioMin = :salarioMin, totalSemFgts = :totalSemFgts, totalTudo = :totalTudo , fgtsEmultas = :fgtsEmultas WHERE idProcesso = :idProcesso AND idUsuario = :idUsuario";
