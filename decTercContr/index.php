            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Cálculo de 13° Salário do Contrato <a href="#modal"><img src="../img/ajuda.png" width="30"></a></h4>
                            </div>
                            <div class="content">
...
?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">  <div class="form-group">
                                                <label for="mesesTrabalhados">Quantidade de 13° não pagos</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><b>Total de 13° não pagos</b><p id="total"></p></label>
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <h3>Cálculo de 13° salário do contrato </h3>
  <p>
    Preenchimento automático com a seguinte fórmula:

  </p></br>
  <p style="font-weight: bolder">Remuneração habitual digitada na página inicial x quantidade de 13º. Salários não pagos
    <br><br></p>
